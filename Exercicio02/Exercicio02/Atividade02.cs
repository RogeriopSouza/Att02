...
namespace Exercicio02
{
    public class Atividade02
    {
        ...
        {
            // criar uma programa que faça a cotação do dolar
            ...
            Console.WriteLine("Informe a QUANTIDADE de Dolar que deseja trocar por Real brasileiro!");
            double QTA = double.Parse(Console.ReadLine());
            Console.WriteLine();
            double Cotacao = QTA * Dollar;
            Console.WriteLine("esta quantidade de Dollar equivale em reis o valor de R$: " + Cotacao.ToString("#0.00"));
